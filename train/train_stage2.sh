...
JOB_NAME="stage2"
PROJECT_ROOT="/mnt/c20250607/user/wanghaoran/zyh/scDataTest"
...
SCRIPT_PATH="$PROJECT_ROOT/train/train_stage2_curriculum_lora_rankloss.py"
